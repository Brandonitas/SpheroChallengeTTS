...
public class MainActivity extends Activity implements RobotChangedStateListener, ResponseListener, TextToSpeech.OnInitListener {
    ...
    private Button go, stop, arriba, derecha, abajo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                convenienceRobot.setLed(1.0f,0.5f,0.0f);
                convenienceRobot.stop();

            }
        });

        DualStackDiscoveryAgent.getInstance().addRobotStateListener(this); //manejar bluet
